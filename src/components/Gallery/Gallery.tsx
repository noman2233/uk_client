...
//   return (
//     <div className={styles.bussiness_district_gallary} ref={ref}>
//       <Slider {...settings}>
//         {Gallry_DummyData.map((item) => (
//           <div className={styles.bussiness_district_gallary_card}>
//             <div className={styles.bussiness_district_gallary_card_main}>
//               <img src={item.img} alt={"title"} onError={handleErrorImage} />
//             </div>
//           </div>
//         ))}
//       </Slider>
